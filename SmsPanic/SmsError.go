...
func (e *tSmsError) IsErrorDefined(ec string) bool {
	for k := range e.m {
		if k == ec {
			return true
		}
...
func (e *tSmsError) ErrorReval(err interface{}, w http.ResponseWriter) {
	es := err.(string)
